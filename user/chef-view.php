      ...
      <section class="content">
        <div class="row">
          ...
          <div class="col-sm-3 text-center">
            <a href="#" class="btn btn-default btn-block text-uppercase">Book this chef</a>
            <br>
            <a href="#" class="h4 text-bold primary-color btn-block"><i class="fa fa-heart-o"></i> &nbsp; Add to my favourites</a>
            <br>
            <div class="row">
              <div class="col-xs-3">
                <label>Share</label>
