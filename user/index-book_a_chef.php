      ...
      <div class="main-area" style="background-image: url(&quot;../dist/img/homepage--for-chefs.jpg&quot;);">
        ...
        <div class="text-uppercase heading">
          <div class="row col-sm-8 col-sm-offset-2">
            <h1>Best Chefs-on-demand<br class="hidden-xs">
            <span class="primary-color"><b>Right near you</b></span></h1>
            <div class="col-sm-4 col-sm-offset-4"><a href="signup.php" class="btn btn-default btn-block">Book a chef</a></div>
          </div>
        </div>
